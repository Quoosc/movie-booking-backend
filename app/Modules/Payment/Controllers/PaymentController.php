...
use App\Modules\Payment\Services\CheckoutLifecycleService;
    ...
    public function searchPayments(Request $request): JsonResponse
    {
        ...
        return response()->json([
            ...
            'data' => $payments->map(fn($p) => [
                ...
                'amount' => $p->amount,
                'currency' => $p->currency,
                'status' => \App\Modules\Payment\Transformers\PaymentTransformer::mapStatusForResponse($p->status->value ?? $p->status),
