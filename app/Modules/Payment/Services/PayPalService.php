...
use App\Modules\Payment\DTO\InitiatePaymentRequest;
use App\Modules\Payment\DTO\InitiatePaymentResponse;
use App\Modules\Payment\DTO\PaymentResponse;
    ...
    public function captureOrder(string $orderId): PaymentResponse
    {
        return DB::transaction(function () use ($orderId) {
            ...
            if ($payment->status !== PaymentStatus::PENDING) {
                ...
                $resp = \App\Modules\Payment\Transformers\PaymentTransformer::toPaymentResponse($payment);
            ...
            if (!$res->successful()) {
                ...
                $resp = \App\Modules\Payment\Transformers\PaymentTransformer::toPaymentResponse($updated);
                return new PaymentResponse(
                    paymentId: $resp['paymentId'],
                    bookingId: $resp['bookingId'],
                    bookingStatus: $resp['bookingStatus'],
